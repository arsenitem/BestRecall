          ...
          >
            <template #cell(image)>
              <b-icon
                icon="person-circle"
                font-scale="3"
                style="margin-left: 30px; color: #9eb1b5"
              ></b-icon>
            </template>
            <template #cell(riskLevel)="level">
              <b-button pill v-if="level.item.riskLevel === 3" class="risk-3"
                >Высокий</b-button
              >
              <b-button pill v-if="level.item.riskLevel === 2" class="risk-2"
                >Умеренный</b-button
              >
              <b-button pill v-if="level.item.riskLevel === 1" class="risk-1"
                >Низкий</b-button
              >
            </template>
            <template #cell(actions)="data">
              <b-icon
                ...
                font-scale="3"
                class="card-ico"
                @click="onMedLinkClick(data)"
              ></b-icon>
            </template>
          </b-table>
        </b-card>
      </b-tab>
      <b-tab title="Новый пациент" @click="onNewPatientClick"> </b-tab>
    </b-tabs>
  </b-row>
</template>
